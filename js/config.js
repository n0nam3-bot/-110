const CONFIG = {
  ...
  app: {
    ...
    baseUrl: "https://n0nam3-bot.github.io/-110",
    version: "1.0.5"          // bump this to bust all caches on deploy
  },
  cache: {
    odds: 15*60*1000, picks: 30*60*1000,
    espn: 5*60*1000, injuries: 60*60*1000, stats: 30*60*1000,
    inMemory: 30*60*1000      // in-memory sport tab cache TTL
  },
  sports: {
  ...
  llm: {
    gemini:     { endpoint:(k)=>`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${k}` },
  ...
  autoRefreshMs: 30 * 60 * 1000   // 30 min background refresh
};
const KEYS = {
